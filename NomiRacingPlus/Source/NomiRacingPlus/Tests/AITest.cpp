...
bool FAIStateTransitionTest::RunTest(const FString& Parameters)
{
	...
	EAIState Braking = EAIState::Braking;
	...
	TestNotEqual(TEXT("Braking should differ from Recovering"), (int32)Braking, (int32)Recovering);
...
bool FAIBehaviorTreeTest::RunTest(const FString& Parameters)
{
	...
	RBConfig.bEnabled = true;
	RBConfig.SpeedBoostPerPosition = 0.02f;
	RBConfig.MaxSpeedBoost = 0.2f;
